...
```
mamba create --name stripes --clone preproc
...
uni=$(find $BIDS_DIR/$SUB/$SES/anat -name "*UNI.nii*")
inv1=$(find $BIDS_DIR/$SUB/$SES/anat -name "*inv-1.nii*")
inv2=$(find $BIDS_DIR/$SUB/$SES/anat -name "*inv-2.nii*")
T1map=$(find $BIDS_DIR/$SUB/$SES/anat -name "*T1map.nii*")
